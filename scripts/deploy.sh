...
for MIG in database/migrations/create_statistics_tables.sql database/migrations/convert_timestamp_to_datetime_wib.sql database/migrations/add_attachment_url_to_messages.sql; do
  if [ -f \"$MIG\" ]; then
